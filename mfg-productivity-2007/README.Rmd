...
pandoc.table(summary(values), caption='Table 1: Summary of Metro Manufacturing Productivity in 2007')
```
...
panderOptions('table.split.table', 300)
panderOptions('big.mark', ',')
pandoc.table(head(econ.census[,c('Metro','Productivity')]), caption='Table 2: Most Productive Metros in 2007')
```
...
panderOptions('table.split.table', 300)
panderOptions('big.mark', ',')
pandoc.table(prod.tail, caption='Table 3: Least Productive Metros in 2007')
```
...
panderOptions('table.split.table', 300)
panderOptions('big.mark', ',')
pandoc.table(descriptive.statistics, style='rmarkdown', caption='Table 4: Descriptive Statistics for Study Data')
```
...
panderOptions('table.split.table', 300)
pander(lm.mtable, caption='Table 5: Regression Model Results')
```